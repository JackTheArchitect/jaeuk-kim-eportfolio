...
module.exports.bsContactList = function(req, res, next) {  
    businessContact.find((err, bsContactList) => {        
        if(err)
        {
        ...
        else
        {
            res.render('business_contact/list', {
                ...
                InventoryList: bsContactList, // needs to be fixed
...
module.exports.displayEditPage = (req, res, next) => {
    ...
    businessContact.findById(id, (err, itemToEdit) => {
        if(err)
        {
            console.log(err);
            res.end(err);
        ...
        {
            //show the edit view
            res.render('business_contact/add_edit', {
...
module.exports.processEditPage = (req, res, next) => {
    ...
    Inventory.updateOne({_id: id}, updatedItem, (err) => {
        ...
        else
        {
            ...
            res.redirect('/business_contact/list');
        }
    });
...
module.exports.displayAddPage = (req, res, next) => {
    ...
    res.render('bsContactList/add_edit', {
...
module.exports.processAddPage = (req, res, next) => {
    ...
    Inventory.create(newItem, (err, item) =>{
        ...
        else
        {
            // refresh the book list
            console.log(item);
            res.redirect('/bsContactList/list');
        }
    });
